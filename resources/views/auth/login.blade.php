    ...
    <div class="w-full lg:w-[55%] flex items-center justify-center p-6 sm:p-12 relative">
        <div class="w-full max-w-md bg-white rounded-[2.5rem] p-8 sm:p-12 shadow-2xl shadow-brand-900/5 border border-gray-100">
            ...
            <form action="#" method="POST" class="mt-8">
                @csrf
                <button type="button" class="w-full py-3.5 px-4 bg-white border-2 border-gray-100 text-gray-700 font-semibold rounded-2xl shadow-sm hover:bg-gray-50 hover:border-gray-200 transition-all duration-300 flex items-center justify-center gap-3">
