    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center bg-white/50 px-6 py-2 rounded-full border border-white/80 shadow-sm gap-1">
                ...
                <a href="{{ route('rekomendasi.kreator') }}" class="px-4 py-2 {{ request()->routeIs('rekomendasi.kreator') ? 'bg-[#2563EB] text-white shadow-md shadow-[#2563EB]/20' : 'text-[#1E3A8A]/70 hover:text-[#2563EB]' }} rounded-full text-sm font-bold transition-all">Rekomendasi AI</a>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative" id="notif-wrapper">
                    <button onclick="toggleNotifDropdown(event)" class="relative p-2.5 bg-white border border-[#2563EB]/10 rounded-xl hover:bg-[#EFF6FF] transition-all group">
