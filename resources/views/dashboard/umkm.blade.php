    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Konekin - UMKM</h1>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Profil Usaha</h2>
                <div class="space-y-4">
                    <div>
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">UMKM</p>
                    </div>
                    <div>
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <p class="text-sm text-gray-600 mb-2">Riwayat Pengeluaran</p>
                ...
                <!-- Edit Profile -->
                <div class="bg-white rounded-lg shadow p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Edit Profil Usaha</h2>
                    <form action="{{ route('dashboard.update-profile') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label for="bio" class="block text-sm font-medium text-gray-700 mb-1">Deskripsi Usaha</label>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700">
                            <span class="mr-3">📊</span> Kelola Proyek
                        </li>
                        <li class="flex items-center text-gray-700">
                            <span class="mr-3">👥</span> Cari Creative Workers
                        </li>
                        <li class="flex items-center text-gray-700">
                            <span class="mr-3">📝</span> Manajemen Tim
                        </li>
                        <li class="flex items-center text-gray-700">
                            <span class="mr-3">💼</span> Kelola Budget
                        </li>
                    </ul>
                </div>
            </div>
