    ...
    <main class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white p-6 rounded-3xl border border-[#2563EB]/5 shadow-sm hover:shadow-xl hover:shadow-[#2563EB]/5 transition-all group">
                ...
                <p class="text-3xl font-display font-bold mt-1 text-[#1E3A8A]">4</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-[#2563EB]/5 shadow-sm hover:shadow-xl hover:shadow-[#2563EB]/5 transition-all group">
                ...
                <h3 class="text-[#1E3A8A]/60 text-sm font-bold uppercase tracking-wider">Total Investasi</h3>
                <p class="text-3xl font-display font-bold mt-1 text-[#1E3A8A]">Rp 15.2M</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-[#2563EB]/5 shadow-sm hover:shadow-xl hover:shadow-[#2563EB]/5 transition-all group">
                ...
                <h3 class="text-[#1E3A8A]/60 text-sm font-bold uppercase tracking-wider">Kreator Terhubung</h3>
                <p class="text-3xl font-display font-bold mt-1 text-[#1E3A8A]">18</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-3xl border border-[#2563EB]/5 shadow-sm hover:shadow-xl hover:shadow-[#2563EB]/5 transition-all group">
                ...
                <h3 class="text-[#1E3A8A]/60 text-sm font-bold uppercase tracking-wider">Rating Usaha</h3>
                <p class="text-3xl font-display font-bold mt-1 text-[#1E3A8A]">4.8</p>
            </div>
        </div>
