                    ...
                    <div class="relative h-64 rounded-[2rem] overflow-hidden mb-6">
                        ...
                        @if($portfolio->file_url)
                            <div class="absolute bottom-4 right-4">
                                <a href="{{ route('portfolio.attachment', $portfolio->id) }}" target="_blank" class="p-3 bg-white/90 backdrop-blur-md text-[#2563EB] rounded-xl shadow-lg flex items-center gap-2 hover:bg-[#2563EB] hover:text-white transition-all">
