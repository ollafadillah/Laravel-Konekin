...
<body class="antialiased text-[#1E3A8A]">
    ...
    <main class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-[#1E3A8A]/60 font-medium">Atur informasi usaha agar creative worker lebih mudah mengenal brand, kontak, dan identitas bisnismu.</p>
        </div>
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-white p-8 rounded-[2.5rem] border border-[#2563EB]/5 shadow-sm">
                <div class="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div class="flex-grow text-center md:text-left">
                        ...
                        <p class="text-sm text-[#1E3A8A]/60 mb-4 font-medium">Upload logo atau foto representatif brand agar creative worker lebih cepat mengenali usahamu. Format JPG, PNG max 2MB.</p>
            ...
            <div class="bg-white p-8 rounded-[2.5rem] border border-[#2563EB]/5 shadow-sm space-y-6">
                <h3 class="text-xl font-display font-bold text-[#1E3A8A] border-b border-[#2563EB]/5 pb-4">Informasi Usaha</h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-[#1E3A8A]/70 ml-1">Nama Usaha</label>
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] border border-[#2563EB]/10 focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 outline-none transition-all font-medium text-[#1E3A8A]" placeholder="Nama usaha atau brand">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" class="w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] border border-[#2563EB]/10 focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 outline-none transition-all font-medium text-[#1E3A8A]" placeholder="08xxxxxxxxxx">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="city" value="{{ old('city', $user->city) }}" class="w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] border border-[#2563EB]/10 focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 outline-none transition-all font-medium text-[#1E3A8A]" placeholder="Contoh: Bandung">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="address" value="{{ old('address', $user->address) }}" class="w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] border border-[#2563EB]/10 focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 outline-none transition-all font-medium text-[#1E3A8A]" placeholder="Alamat usaha">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="bio" rows="5" class="w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] border border-[#2563EB]/10 focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/5 outline-none transition-all font-medium text-[#1E3A8A] resize-none" placeholder="Ceritakan bidang usaha, produk utama, dan kebutuhan kreatif brand-mu...">{{ old('bio', $user->bio) }}</textarea>
